class BudgetApp {
  ...
  updateItem() {
    ...
    this.editedItem.querySelector(this.UiSelectors.itemValue).textContent =
      this.formatPrice(
  ...
  // to są 2 fumckje dot localStoarage ; wywołanie funkcji setItem jest wszędzie tam gdzie zachodzi jakaś zmiana
  // natomiast wywołanie funkcji getItem jest tam gdzie inicjalizacja
  // dodatkowo po get trzeba jeszcze wywołać wszystko
  setLocalStorage() {
